...
<div class="sysinfo">'.date("Y").' &copy; '.APP_NAME.'('.APP_VERSION.') <a href="'.APP_URL.'" target="_blank">weentech.com</a> Done in '.$sys_runtime.' second(s), '.APP::$DB->query_nums.' queries, GMT' .APP::$_CFG['Timezone'].' ' .DisplayDate('', '', 1).'</div>	
</body>
</html>';
	}
