 ...
 * $Id: flow.php 2015-07-12 update 527hang and 2167 insert set_default_address wangshuai$
 */
    ...
    else
    {
        ...
        if (!empty($_POST['act']) && $_POST['act'] == 'signin')
        {
            ...
            if ($user->login($_POST['username'], $_POST['password'],isset($_POST['remember'])))
            {
                ...
                $sql = "SELECT COUNT(*) FROM " . $ecs->table('cart') . " WHERE session_id = '" . SESS_ID . "' and user_id = '" . $_SESSION['user_id'] . "' ";
                if ($db->getOne($sql) > 0)
                {
...
/* 设置默认地址 */
elseif ($_REQUEST['step'] == 'set_default_address')
{
	$consignee = array(
