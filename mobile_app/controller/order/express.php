...
//    $order_info['invoice_no'] = '229263735589';  //test quq
//    $order_info['shipping_name'] = '申通快递';

    //$order_info['invoice_no'] = '210847275058';  //test quq
    //$order_info['shipping_name'] = '百世汇通';
    ...
    if (empty($data['status']) || $data['status']=='2'){
        GZ_Api::outPut(array('content'=>array('context'=>"'$data[message]'", 'time'=>''), 'shipping_name'=>$order_info['shipping_name']));
    }
    elseif (empty($data)) {
