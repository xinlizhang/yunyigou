<?php
    ...
    switch ($tmp[0]) {
        case 'checkOrder':
            ...
            /* 商品列表 */
            $cart_goods = cart_goods_withPic($flow_type);               // 取得商品列表
            $out['goods_list'] = $cart_goods;
            ...
            $out['your_integral'] = $user_info['pay_points'];
            ...
            {
                //$out['allow_use_integral'] = 1;
                $out['order_max_integral'] = flow_available_points();
            } else {
                $out['order_max_integral'] = 0;
            }
                ...
                && ($flow_type != CART_GROUP_BUY_GOODS && $flow_type != CART_EXCHANGE_GOODS))
            {
                ...
                if (!empty($user_bonus))
                {
                    ...
                    $out['bonus'] = $user_bonus;
                }

                // 能使用红包
                $out['allow_use_bonus'] = 1;
            }
            ...
            if (!isset($_CFG['use_how_oos']) || $_CFG['use_how_oos'] == '1')
            {
                ...
                {
                    // $out['how_oos_list'] = $GLOBALS['_LANG']['oos'];//是否使用缺货处理
                }
            }
                ...
                && trim($_CFG['invoice_content']) != '' && $flow_type != CART_EXCHANGE_GOODS)
            {
                ...
                $out['inv_content_list'] = $inv_content_list;//能否开发票
                ...
                $out['inv_type_list'] = $inv_type_list;//能否开发票
            }
        ...
        case 'done':
            ...
            /* 订单中的商品 */
            $cart_goods = cart_goods_withPic($flow_type);
