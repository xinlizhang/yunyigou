<?php
    ...
    /*------------------------------------------------------ */
        ...
        else
        {
            ...
            $smarty->assign('promote_start_date', $goods['promote_start_date']);
            $smarty->assign('promote_end_date',   $goods['promote_end_date']);
            $smarty->assign('is_promote',         $goods['is_promote']);
