...
define('GZ_PATH', dirname(__FILE__));       // 当前文件所在目录
define('EC_PATH', dirname(GZ_PATH));        // 当前文件目录上层
...
require GZ_PATH.'/library/init.php';
require GZ_PATH.'/library/function_goods.php';
