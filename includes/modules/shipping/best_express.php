...
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/best_express.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 插件的作者 */
    $modules[$i]['author']  = '云易购';

    /* 插件作者的官方网站 */
    $modules[$i]['website'] = 'http://www.yunyigou.com';
    ...
    /* 打印单背景 */
    $modules[$i]['print_bg'] = '/images/receipt/dly_best.jpg';
...
class best_express
{
    ...
    function query($invoice_sn)
    {
        $str = '<form style="margin:0px" methods="post" '.
            'action="http://www.best_express.cn/bill.asp" name="queryForm_' .$invoice_sn. '" target="_blank">'.
