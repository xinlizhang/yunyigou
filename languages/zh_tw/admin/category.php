...
$_LANG['keywords'] = '關鍵字';
$_LANG['cat_desc'] = '分類描述';
$_LANG['lab_icon'] = '上傳分類標識';
$_LANG['lab_picture'] = '上傳分類圖片';
$_LANG['lab_thumb'] = '上傳分類縮略圖';
$_LANG['lab_icon_url'] = '分類列表小標識URL';
$_LANG['lab_picture_url'] = '分類圖片外部URL';
$_LANG['lab_thumb_url'] = '分類縮略圖外部URL';
...
$_LANG['invalid_category_icon'] = '分類Icon圖片格式不正確！';
$_LANG['invalid_category_img'] = '分類圖片格式不正確！';
$_LANG['invalid_category_thumb'] = '分類縮略圖格式不正確！';
$_LANG['category_icon_too_big'] = '分類Icon圖片文件太大了（最大值：%s），無法上傳。';
$_LANG['category_img_too_big'] = '分類圖片文件太大了（最大值：%s），無法上傳。';
$_LANG['category_thumb_too_big'] = '分類縮略圖文件太大了（最大值：%s），無法上傳。';
