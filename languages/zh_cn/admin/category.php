...
$_LANG['keywords'] = '关键字';
$_LANG['cat_desc'] = '分类描述';
$_LANG['lab_icon'] = '上传分类标识(icon)';
$_LANG['lab_picture'] = '上传一级分类图片';
$_LANG['lab_thumb'] = '上传二级分类图片';
$_LANG['lab_icon_url'] = '分类列表小标识URL';
$_LANG['lab_picture_url'] = '分类图片外部URL';
$_LANG['lab_thumb_url'] = '分类缩略图外部URL';
...
$_LANG['invalid_category_icon'] = '分类Icon图片格式不正确！';
$_LANG['invalid_category_img'] = '分类图片格式不正确！';
$_LANG['invalid_category_thumb'] = '分类缩略图格式不正确！';
$_LANG['category_icon_too_big'] = '分类Icon图片文件太大了（最大值：%s），无法上传。';
$_LANG['category_img_too_big'] = '分类图片文件太大了（最大值：%s），无法上传。';
$_LANG['category_thumb_too_big'] = '分类缩略图文件太大了（最大值：%s），无法上传。';
