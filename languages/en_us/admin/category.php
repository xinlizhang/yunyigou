...
$_LANG['lab_icon'] = 'Upload icon';
$_LANG['lab_picture'] = 'Upload picture';
$_LANG['lab_thumb'] = 'Upload thumbnail';
$_LANG['lab_icon_url'] = 'Category picture icon URL';
$_LANG['lab_picture_url'] = 'Category picture external URL';
$_LANG['lab_thumb_url'] = 'External category Thumbnail URL';
...
$_LANG['invalid_category_icon'] ='Category icon picture format inaccuracy!';
$_LANG['invalid_category_img']='Category img picture format inaccuracy!';
$_LANG['invalid_category_thumb'] ='Category thumb picture format inaccuracy!';
$_LANG['category_icon_too_big'] ='Category icon picture file is too big(the biggest value: %s), can\'t upload.';
$_LANG['category_img_too_big'] ='Category picture file is too big(the biggest value: %s), can\'t upload.';
$_LANG['category_thumb_too_big'] ='Category thumbnail file is too big(the biggest value: %s), can\'t upload.';
