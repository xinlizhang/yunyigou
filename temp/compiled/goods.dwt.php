...
<?php echo $this->smarty_insert_scripts(array('files'=>'transportGoods.js')); ?>
...
<div class="block clearfix">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
     <a href="<?php echo $this->_var['pictures']['0']['img_url']; ?>" title="<?php echo $this->_var['goods']['goods_style_name']; ?>">
      <img src="<?php echo $this->_var['goods']['goods_img']; ?>" id="big_img" alt="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" width="363px;" height="363px"/>
     </a>
     ...
     <div class="textInfo">
     <form action="javascript:addToCartGoods(<?php echo $this->_var['goods']['goods_id']; ?>)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
...
?>
      ...
      <strong><?php echo $this->_var['lang']['promote_price']; ?></strong><font id="goods_promote_price" class="shop"><?php echo $this->_var['goods']['promote_price']; ?></font><br />
      ...
      <img src="themes/yunyigou/images/stars<?php echo $this->_var['goods']['comment_rank']; ?>.gif" alt="comment rank <?php echo $this->_var['goods']['comment_rank']; ?>" />
       </dd>
      </li>
      
      <li class="clearfix">
       <dd>
       <strong>累计售出：</strong><?php 
$k = array (
  'name' => 'goods_sells',
...
?>
      ...
      <li class="clearfix">
       <dd><strong><?php echo $this->_var['lang']['goods_sn']; ?></strong><?php echo $this->_var['goods']['goods_sn']; ?></dd>
       </li> 
        <?php endif; ?>
...
?>
      ...
      <li class="clearfix">
       ...
       <?php if ($this->_var['goods']['goods_number'] != "" && $this->_var['cfg']['show_goodsnumber']): ?>
        <?php if ($this->_var['goods']['goods_number'] == 0): ?>
          （当前库存<font color='red'><?php echo $this->_var['lang']['stock_up']; ?></font>）
        <?php else: ?>
          （当前库存<?php echo $this->_var['goods']['goods_number']; ?> <?php echo $this->_var['goods']['measure_unit']; ?>）
        <?php endif; ?>
       <?php endif; ?>
       </dd>
       </li>
      ...
      <li class="padd">
      <a href="javascript:addToCartGoods(<?php echo $this->_var['goods']['goods_id']; ?>)" style="float:left;"><img src="themes/yunyigou/images/add_cart.png" /></a>
      	<div class="collect">
        	<ul>
        	<li><?php if ($this->_var['affiliate']['on']): ?>
              &nbsp;&nbsp;<a href="user.php?act=affiliate&goodsid=<?php echo $this->_var['goods']['goods_id']; ?>">分享</a>
              <?php endif; ?>
             </li>
            <li><a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>)">收藏商品</a><?php 
$k = array (
  'name' => 'goods_collect',
  'goods_id' => $this->_var['id'],
);
...
?>
          ...
          <strong><?php echo $this->_var['lang']['then_old_price']; ?></strong><font class="shop"><?php echo $this->_var['package_goods']['saving']; ?></font><br />
					...
					<td bgcolor="#FFFFFF">
					<a href="javascript:addPackageToCart(<?php echo $this->_var['package_goods']['act_id']; ?>)" style="background:transparent"><img src="themes/yunyigou/images/bnt_buy_1.gif" alt="<?php echo $this->_var['lang']['add_to_cart']; ?>" /></a>
					</td>
				</tr>
	    </table>
       <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
