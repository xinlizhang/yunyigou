...
<?php if ($this->_var['full_page']): ?>
  ...
  <div>
    ...
    <input name="remove" type="submit" id="btnSubmit3" value="<?php echo $this->_var['lang']['remove']; ?>" class="button" disabled="true" onclick="confirm_del();this.form.target = '_self'" />
...
{
	alert("<?php echo $this->_var['lang']['confirm_delete']; ?>");
}
