...
?>
  <tr align="center" class="<?php echo $this->_var['cat']['level']; ?>" id="<?php echo $this->_var['cat']['level']; ?>_<?php echo $this->_var['cat']['cat_id']; ?>">
    ...
    <td width="20%"><img src="images/<?php if ($this->_var['cat']['show_in_index'] == '1'): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'category_goods_is_show', <?php echo $this->_var['cat']['cat_id']; ?>)" /></td>
    <td width="20%" align="center"><span onclick="listTable.edit(this, 'category_goods_sort_order', <?php echo $this->_var['cat']['cat_id']; ?>)"><?php echo $this->_var['cat']['sort_order_index']; ?></span></td 
  ></tr>
